                    ...
                    return GestureDetector(
                      onTap: () {
                        Get.to(() =>
                            ...
                            details:
                                controller.sportsNewsList[index].description.toString(),
                            image: controller.sportsNewsList[index].urlToImage,
                              content: controller.sportsNewsList[index].content.toString(),
                              shareURL: controller.sportsNewsList[index].urlToImage.toString(),
                              source: controller.sportsNewsList[index].source.name.toString(),
                              publishDT: controller.sportsNewsList[index].publishedAt.toString(),
                          ));
                      },
                      child: Padding(
                        ...
                        child: Card(
                          ...
                          child: Container(
                            ...
                            child: Column(
                                children: [
                                  controller.sportsNewsList[index].urlToImage
                                       ==
                                      null
                                      ? Expanded(
                                      child:
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(controller.sportsNewsList[index].title.toString()),
                                  )
                                  //  ],
                                ]),
                          ),
